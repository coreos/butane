...
func TranslateTest(t *testing.T, data translateTestData) {
	...
	actual, translations, r := data.in.ToIgn3_4Unvalidated(common.TranslateOptions{})
	assert.Equal(t, data.out, actual, "translation mismatch")
	assert.Equal(t, data.report, r, "report mismatch")
	baseutil.VerifyTranslations(t, translations, data.exceptions)
	assert.NoError(t, translations.DebugVerifyCoverage(actual), "incomplete TranslationSet coverage")

}
func TestEmptyConfig(t *testing.T) {
	var test translateTestData
	// empty config
	test.in = Config{}
	test.out = types.Config{
		Ignition: types.Ignition{
			Version: "3.4.0-experimental",
		},
	}
	test.exceptions = []translate.Translation{
		{path.New("yaml", "version"), path.New("json", "ignition", "version")},
	}
	test.report = report.Report{}

	TranslateTest(t, test)

}

func TestIncorrectPartitionNumberRoot(t *testing.T) {
	var test translateTestData
	test.in = Config{
		Config: base.Config{
...
func TestRootPartitionTooSmall(t *testing.T) {
	var test translateTestData
...
func TestRootPartitonConstrainedNoValues(t *testing.T) {
	var test translateTestData
	test.in = Config{
		Config: base.Config{
			Storage: base.Storage{
...
func TestRootPartitionContsrainedSpecified(t *testing.T) {
	var test translateTestData
	test.in = Config{
		Config: base.Config{
			Storage: base.Storage{
	...
	test.exceptions = []translate.Translation{
		...
		{path.New("yaml", "storage", "disks", 0, "partitions", 1, "label"), path.New("json", "storage", "disks", 0, "partitions", 1, "label")},
		{path.New("yaml", "storage", "disks", 0, "partitions", 1, "size_mib"), path.New("json", "storage", "disks", 0, "partitions", 1, "sizeMiB")},
		{path.New("yaml", "storage", "disks", 0, "partitions", 1, "start_mib"), path.New("json", "storage", "disks", 0, "partitions", 1, "startMiB")},
		{path.New("yaml", "storage", "disks", 0, "partitions", 0), path.New("json", "storage", "disks", 0, "partitions", 0)},
		{path.New("yaml", "storage", "disks", 0), path.New("json", "storage", "disks", 0)},
		{path.New("yaml", "storage", "filesystems", 0, "device"), path.New("json", "storage", "filesystems", 0, "device")},
		{path.New("yaml", "storage", "filesystems", 0, "format"), path.New("json", "storage", "filesystems", 0, "format")},
...
func TestLUKSx86_64(t *testing.T) {
	var test translateTestData
	test.in = Config{
...
func Test3DiskMirror_x86_64(t *testing.T) {
	var test translateTestData
...
func Test3DiskMirrorLUKS_x86_64(t *testing.T) {
	var test translateTestData
...
func Test2DiskMirrorLUKS_aarch64(t *testing.T) {
	var test translateTestData
	test.in = Config{
		BootDevice: BootDevice{
...
func Test2DiskMirrorLUKS_ppc64le(t *testing.T) {
	var test translateTestData
...
func Test2DiskMirrorLUKSOverideFS_x86(t *testing.T) {
	var test translateTestData
...
func TestGrub1User(t *testing.T) {
	var test translateTestData
	test.in = Config{
		Grub: Grub{
			Users: []GrubUser{
...
func TestGrub2UsersWithDiffrentHashes(t *testing.T) {
	var test translateTestData
	test.in = Config{
		Grub: Grub{
			Users: []GrubUser{

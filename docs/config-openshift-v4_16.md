...
* **version** (string): the semantic version of the spec for this document. This document is for version `4.16.0` and generates Ignition configs with version `3.4.0`.

...
# OpenShift Specification v4.10.0-experimental
...
* **version** (string): the semantic version of the spec for this document. This document is for version `4.10.0-experimental` and generates Ignition configs with version `3.4.0-experimental`.

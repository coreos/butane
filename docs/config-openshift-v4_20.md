...
title: OpenShift v4.20.0
parent: Configuration specifications
nav_order: 137
---

# OpenShift Specification v4.20.0
...
* **version** (string): the semantic version of the spec for this document. This document is for version `4.20.0` and generates Ignition configs with version `3.5.0`.

...
title: OpenShift v4.21.0
parent: Configuration specifications
nav_order: 136
---

# OpenShift Specification v4.21.0
...
* **version** (string): the semantic version of the spec for this document. This document is for version `4.21.0` and generates Ignition configs with version `3.5.0`.

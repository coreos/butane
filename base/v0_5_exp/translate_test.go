	...
	tests := []struct {
		...
		},
		{
			...
			[]translate.Translation{
				...
				{From: path.New("yaml", "ssh_authorized_keys_local", 0), To: path.New("json", "sshAuthorizedKeys", 4)},
				{From: path.New("yaml", "ssh_authorized_keys_local", 0), To: path.New("json", "sshAuthorizedKeys", 5)},
			},
			"",
			sshKeyDir,
		},
		{
			...
			[]translate.Translation{
				...
				{From: path.New("yaml", "ssh_authorized_keys_local", 1), To: path.New("json", "sshAuthorizedKeys", 4)},
				{From: path.New("yaml", "ssh_authorized_keys_local", 1), To: path.New("json", "sshAuthorizedKeys", 5)},
				{From: path.New("yaml", "ssh_authorized_keys_local", 1), To: path.New("json", "sshAuthorizedKeys", 6)},
			},
			"",
			sshKeyDir,
		},
		...
		},
		{
			...
			[]translate.Translation{
				...
				{From: path.New("yaml", "ssh_authorized_keys_local", 0), To: path.New("json", "sshAuthorizedKeys", 4)},
				{From: path.New("yaml", "ssh_authorized_keys_local", 0), To: path.New("json", "sshAuthorizedKeys", 5)},
				{From: path.New("yaml", "ssh_authorized_keys_local", 0), To: path.New("json", "sshAuthorizedKeys", 6)},
			},
			"",
			sshKeyDir,
		},
